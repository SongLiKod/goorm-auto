...
### 2、执行以下代码
`bash <(curl -s -L https://raw.githubusercontent.com/SongLiKod/goorm-auto/master/install.sh)`

### 3、开放内部端口
![image](https://github.com/SongLiKod/goorm-auto/blob/master/port.png)
...
![image](https://github.com/SongLiKod/goorm-auto/blob/master/proxy.png)
